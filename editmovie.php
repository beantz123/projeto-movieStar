<?php 
    ...
    /* pegar o id sendo mandado pela requisição */
                ...
                <form action="<?= $BASE_URL ?>movie_process.php" id="edit-movie-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category" id="category">
                            ...
                            <!-- aqui ta usando um operador ternario para verificar qual é a categoria do filme
                             e se for a correta selecionar ela no input e exbir -->

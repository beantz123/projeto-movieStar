<?php 
    ...
    /* vai pegar o id sendo enviado pela requisição, 
    ou seja o id que vai estar na url quando essa pagina for acessada*/
    ...
    <div id="main-container" class="container-fluid">
        <div class="row">
            <div class="offset-md-1 col-md-6 movie-container">
                ...
                <!-- atributos relacionado ao trailer q vem do yt -->
            ...
            <!-- ocupando a col q sobrou na lateral -->
            <div class="col-md-4">
                <div class="movie-image-container" style="background-image: url('<?= $BASE_URL ?>img/movies/<?= $movie->image ?>')"></div>
            </div>
            <!-- aqui é as avaliações -->
             <div class="offset-md-1 col-md-10" id="reviews-container">
                <h3 id="reviews-title">Avaliações: </h3>
                <!-- verifica se habilita reviews pro usuario ou não -->
                <!-- verificando se o usuario ta logado, se ele nao é dono do filme
                 e se ele ja comentou antes -->
